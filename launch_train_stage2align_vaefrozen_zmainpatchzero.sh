...
$PY -m torch.distributed.run --nproc_per_node=$NUM_GPUS --standalone train_causalvae_geoprior_dit_align.py \
    --exp_name "kinemadae_stage2align_vaefrozen_zmainPatchZero_stage2match_bs${BS}${EXP_SUFFIX}" \
    ...
    --normalize_zmain \
    --zmain_stats_path /NHNHOME/WORKSPACE/0226010404_A/CVLAB/CVLAB2/jeeyoung/Kinemadae-adaptive-Bfix/zmain_stats_loraFreeze_step5500_256x256x17_n200.json \
    --no_fused_align \
