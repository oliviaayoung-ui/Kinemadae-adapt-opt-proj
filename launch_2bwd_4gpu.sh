...
$PY -m torch.distributed.run --nproc_per_node=$NUM_GPUS --rdzv_backend=c10d --rdzv_endpoint=localhost:29501 train_causalvae_geoprior_dit_align.py \
    --exp_name "kinemadae_lora_bn_clamp1e7_align40_bs${BS}${EXP_SUFFIX}_2bwd_4gpu" \
