...
RESUME_CKPT=${RESUME_CKPT:-/NHNHOME/WORKSPACE/0226010404_A/CVLAB/CVLAB2/jeeyoung/Kinemadae-adaptive-Bfix/results/decoder_only_from11500_256x81_bs2_ga4_emaload-lr8.00e-05-bs2-rs256-sr2-fr81/checkpoint-26000.ckpt}
...
$PY -m torch.distributed.run --nproc_per_node=$NUM_GPUS --standalone train_causalvae_geoprior_decoder_only.py \
    ...
    --eval_lpips \
    --eval_noise_robust \
    --noise_robust_sigmas "0.1,0.2,0.3" \
