...
BS=${BS:-8}
EXP_SUFFIX=${EXP_SUFFIX:-_mix81from8500}
...
$PY -m torch.distributed.run --nproc_per_node=$NUM_GPUS --standalone train_causalvae_geoprior_dit_align.py \
    ...
    --freeze_lora \
    --no_log_grad \
    --resume_from_checkpoint "/NHNHOME/WORKSPACE/0226010404_A/CVLAB/CVLAB2/jeeyoung/Kinemadae-adaptive-Bfix/results/kinemadae_stage1_bn_lora_align40_bs8_clamp1e5fix_b_proj_teacherfrozen-lr8.00e-05-bs8-rs256-sr2-fr17/checkpoint-8500.ckpt" \
    --log_adaptive_weight \
    --seed 1234 \
